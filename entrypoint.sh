...
# --- FIX: Added 'text_encoders' to the persistence list ---
COMFYUI_DIRS_TO_PERSIST="input output custom_nodes workflows checkpoints unet vae clip loras t5 controlnet embeddings hypernetworks style_models upscale_models gligen text_encoders"
